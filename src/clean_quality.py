...
# NOTE: presidential-speech FEATURE ENGINEERING (pronoun metrics, speech-type
# classification, word frequencies / TF-IDF distinctiveness) lives in
# src/prepare.py — it is the 03-prepare stage, not cleaning. This module
# (02-clean) is for type casts, column/name normalization, dedupe, and quality
# checks only.
